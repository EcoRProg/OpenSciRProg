...
ggplot(ChlaRearrenged, aes(Date, ChlaInteg, color=Station)) + geom_point() + geom_line() + scale_y_log10() + theme_minimal() + facet_wrap(~Station) + scale_color_brewer(palette = "Pastel1") + stat_smooth()
